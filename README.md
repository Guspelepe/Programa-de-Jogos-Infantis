...
Os jogos desenvolvidos foram:
  ...
  Ligue os Pontos: Interação para formar desenhos lógicos.

  Nave Espacial: Jogo de controle de gravidade e sobrevivência.

  Memória com Números: Associação entre números e quantidades.
...
Principais pontos desenvolvidos:
  ...
  Lógica e Matemática: Implementação de detecção de colisões, gravidade, matrizes bidimensionais e temporizadores de loop.
...
O projeto foi construído puramente com tecnologias e bibliotecas fundamentais:
  ...
  Bibliotecas nativas complementares: Math e Random
